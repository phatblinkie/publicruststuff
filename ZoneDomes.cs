...
namespace Oxide.Plugins
{
    ...
    class ZoneDomes : RustPlugin
    {
        ...
        {
            List<string> invalidZones = Pool.GetList<string>();
        ...
        /// <summary>
        /// API method to create a new dome
        /// </summary>
        /// <param name="player">The</param>
        /// <param name="zoneId">The ID of the zone</param>
        /// <param name="type">The integer type index defined in enum SphereType</param>
        /// <param name="stack">The number of sphere entities to stack</param>
        /// <returns></returns>
